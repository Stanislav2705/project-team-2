...
export const modalCardRef = {
  addWathcedModalBtn: document.querySelector('.add-watched-btn-js'),
  addQueueModalBtn: document.querySelector('.add-queue-btn-js'),
  closeModalBtn: document.querySelector('[data-modal-close]'),
};

export const mainRefs = {
  galleryList: document.querySelector('.section-gallery__list'),
  galleryItem: document.querySelector('.section-gallery__item'),
};
